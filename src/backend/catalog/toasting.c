				   ...
				   Oid OIDOldToast)
{
	 ...
	 * defined, we need to rely on the existing table for the job because we
	 * do not want to create an inconsistent relation that would conflict with
	 * the parent and break the world.
	 */
