...
#define TOAST_POINTER_NOEXT_SIZE (VARHDRSZ_EXTERNAL + sizeof(varatt_external))
#define TOAST_POINTER_EXT_SIZE (VARHDRSZ_EXTERNAL + sizeof(varatt_external) + sizeof(uint8))
